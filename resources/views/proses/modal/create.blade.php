<form id="claimForm" action="{{ url('/proses/upload') }}" method="post" enctype="multipart/form-data">
    @csrf
...
<script>
function editDraft(id, nip, nama, instansi, no_hp, diagnosa,tgl_kejadian,note,surat_jaminan, fpp, kwitansi, taspen_3,rincian_tagihan,resume_medis,bacaan_pemeriksaan_radiologi,salinan_laporan_operasi,surat_jaminan_jasa_raharja,surat_keterangan_platform_jasa_raharja,dokumen_pendukung_lainnya) {
